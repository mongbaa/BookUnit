    ...
    <body>
        ...
        if ($std_year == "5") {
            ...
            ?>>5,6</option>
                ...
                <center><font class="fontthai"><B>พ.ศ.</B>
                    ...
                    </B>&nbsp;<a href="?id=1&CC=<?= $CC ?>&type_work=<?=$type_work?>&std_year=<?= $std_year ?>&from_date_year=<?= $from_date_year ?>">Print</a></font></center>
            </form>
            <?
        ...
        ?>
						...
						<center><font class="fontthai"><B>ปี <?= $from_date_year ?></B></font></center>
        ...
        ?>
						...
						<tr class='font01'>
                                    ...
                                    <tr class='font01'>
										...
										while($i<=12){
											...
											echo "<td align=center><B>".$from_date_month_show."</B></td>";
										$i++;
										}
										?>                                       
			...
			<?
							...
							$ck_date_start=$from_date_year."-".$from_date_month."-01";
							$ck_date_end=$from_date_year."-".$from_date_month."-31";
                            ...
                            $sql_con .= "and e.unit_date >= '$ck_date_start' and e.unit_date <= '$ck_date_end' ";
